...
import NewSiteCreator from '@/components/NewSiteCreator';
...
export default function Page() {
    ...
    async function updateExistingSite(data: FormData) {
    ...
    async function fetchNewSite(data: FormData) {
            ...
            setIsLoading2(true); // Start loading when emitting the event
        socket.emit('getAllSiteData', payload);       
        ...
        <div>
            {isLoading ? (
                ...
                <div className="flex flex-row flex-wrap gap-3 justify-center">
                    ...
                    >
                        <form className="mt-6 max-w-md flex flex-col gap-4" action={updateExistingSite}>
            ...
            <div className="boder-2 border-solid border-slate-300">
            <h1 className="text-2xl font-semibold text-gray-700">Fetch new sites</h1>
            {isLoading2 ? (
                // Display Spinner when loading
                <div className="flex flex-col justify-center items-center">
                    <Spinner />
                ...
                <div className="flex flex-row flex-wrap gap-3 justify-center">
                    <FormWrapper
                        title="Fetch new site"
                        description="Use this form to fetch a NEW site from Salesforce"
                    >
                        <form className="mt-6 max-w-md flex flex-col gap-4" action={fetchNewSite}>
                            {/* Create credentials input fields */}
                            <div>
                                <label htmlFor="username" className="block text-sm font-medium text-gray-700">SALESFORCE Username:</label>
                                <input
