...
//     const houseInfo = useQuery(api.house.getHouseById, { id: houseId as Id<"house"> });
...
export default function Form({ userId, houseId, info, shiftId, house }: FormProps) {
    ...
    async function clientAction() {
        ...
        const fieldValues = {
            ...
            notes: notes.trim() !== "" ? notes.trim() : house?.notes || "",
        };
