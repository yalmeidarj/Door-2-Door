...
CREATE TABLE "Location" (
    "id" SERIAL NOT NULL,
    "name" TEXT,
    "neighborhood" TEXT NOT NULL DEFAULT 'to be verified',
    "priorityStatus" INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE "ShiftLogger" (
    ...
    CONSTRAINT "ShiftLogger_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ShiftLogger_workerId_locationId_key" ON "ShiftLogger"("workerId", "locationId");
...
-- AddForeignKey
ALTER TABLE "ShiftLogger" ADD CONSTRAINT "ShiftLogger_agentId_fkey" FOREIGN KEY ("agentId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
